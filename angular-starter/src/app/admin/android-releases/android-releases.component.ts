...
export class AndroidReleasesComponent implements OnInit{
  ...
  ngOnInit():void{this.load();}load():void{this.api.getReleases().subscribe({next:x=>this.releases=x,error:()=>this.error='Unable to load Android releases.'});}
